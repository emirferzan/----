...
/*
this comparator will return appropiate number
based off of the order of the elements
*/
int cmp(const void *a, const void *b);


/*this function
will use quick sort algorithm
*/

int teamComparisonPayroll(const void *s1, const void *s2);